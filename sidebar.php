...
<div class="sidebar">
  ...
  <a href="index.php" class="nav-link">
    ...
    <span class="label" style="font-size: 15px">Low Magnification</span>
  </a>
</li>
...
<li class="nav-item has-submenu">
  ...
  <ul class="submenu">
    <li><a href="exported_csv.php" class="submenu-item"><i class="fas fa-file-csv"></i> Export CSV</a></li>
    <li><a href="exported_pdf.php" class="submenu-item"><i class="fas fa-file-pdf"></i> Export PDF</a></li>
  </ul>
</li>


<li class="nav-item">
  <a href="images_uploaded.php">
